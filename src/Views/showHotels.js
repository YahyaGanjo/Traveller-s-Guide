...
function showHotels(page, lat, lng) {
  fetchData(
    `https://discover.search.hereapi.com/v1/discover?at=${lat},${lng}&limit=2&lang=en-US&q=hotels&apiKey=j1FYuaIJtBD1DwGX-x5MXWquiUc2fjPZlbBCMoNz5Oc`
  )
    .then((response) => {
